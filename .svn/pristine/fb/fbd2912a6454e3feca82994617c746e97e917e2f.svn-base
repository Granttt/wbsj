package com.wangbo.framework.aspectj;
...
import com.wangbo.common.enums.BusinessStatus;
import com.wangbo.common.json.JSON;
...
public class LogAspect {
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(com.wangbo.common.annotation.Log)")
