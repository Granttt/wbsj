package com.wangbo.common.utils.file;

import java.io.File;
import java.io.IOException;

import com.wangbo.common.exception.file.FileSizeLimitExceededException;
...
import com.wangbo.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
     ...
     */
    private static final String upload(String baseDir, MultipartFile file, String extension)
     ...
     * @throws FileSizeLimitExceededException 如果超出最大大小
     */
    private static final void assertAllowed(MultipartFile file) throws FileSizeLimitExceededException {
