package com.wangbo.generator.util;
...
public class GenUtils {
     ...
     * 获取文件名
     */
    public static String getFileName(@NotNull String template, @NotNull TableInfo table,@NotNull  String moduleName) {
        // 小写类名
     ...
     * @return 模块名
     */
    public static String getModuleName(@NotNull String packageName) {
    ...
    private static String getBasePackage(@NotNull String packageName) {
        int lastIndex = packageName.lastIndexOf(".");
    ...
    private static String replaceKeyword(@NotNull String keyword) {
